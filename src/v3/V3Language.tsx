...
const copy = {
  zh: {
    ...
    about: {
      ...
      bridgeLabel: "从当前方向到能力框架",
      bridge: "为了把这些方向做成真实可运行的系统，我把学习和开发沉淀为感知、嵌入式、软件与交互之间可复用的工程能力。",
    },
    signalInterlude: {
      eyebrow: "当前方向 / 飞行系统如何运作",
      title: "从环境到稳定动作",
      statement: "把激光雷达自主飞行系统拆开看：感知、规划与执行并不独立，而是持续闭合的工程循环。",
      phases: [
        { word: "SENSE", caption: "读取环境", detail: "定位 / 建图 / 状态估计" },
        { word: "PLAN", caption: "选择路径", detail: "约束 / 轨迹 / 安全边界" },
        { word: "FLY", caption: "执行飞行", detail: "控制 / 硬件 / 反馈校正" },
      ],
    },
  ...
  en: {
    ...
    about: {
      ...
      bridgeLabel: "From current focus to working capabilities",
      bridge: "To turn these directions into real, working systems, I build reusable engineering capability across sensing, embedded hardware, software, and interaction.",
    },
    signalInterlude: {
      eyebrow: "Current focus / how the flight system operates",
      title: "From environment to controlled motion",
      statement: "The LiDAR flight system becomes clearer as a loop: sensing, planning, and execution continuously inform one another.",
      phases: [
        { word: "SENSE", caption: "Read the environment", detail: "Localize / map / estimate state" },
        { word: "PLAN", caption: "Choose a path", detail: "Constraints / trajectory / safety" },
        { word: "FLY", caption: "Execute flight", detail: "Control / hardware / feedback" },
      ],
    },
